...
module Decidim
  RSpec.describe 'submit project as edytor', type: %i[feature mailer] do
    ...
    let!(:user) do
      create(
        ...
        ad_role: :decidim_bo_bie_edytor
      )
    end

    it 'creates project, redirect to show, delegate project to acceptance with flash message' do
      sign_in(user)
      visit url_target
      ...
      fill_in 'Szacunkowy koszt realizacji projektu',
              with: 1000
