...
module Decidim
  RSpec.describe 'submit project as koordynator', type: %i[feature mailer] do
    ...
    it 'creates project, redirect to show with flash message' do
      ...
      fill_in 'Opis projektu',
              with: 'Opis projektu'
      check('Tak')
      fill_in 'Uzasadnienie realizacji projektu', with: 'Uzasadnienie realizacji projektu'
      check('edukacja')
      check('dorośli')
      select('Bielany')
      ...
      # AFTER creating a project - current path is not changed - it is still: url_target
      # Moreover - there is flash alert: 'Nie masz uprawnień do wykonania tej czynności'
