...
Decidim.configure do |config|
  ...
  config.application_name = "Decidim BO Warszawa"

  # The email that will be used as sender in all emails from Decidim
  config.mailer_sender = ENV["SMTP_FROM"].presence || "test@twojbudzet.warszawa.pl"
  ...
  config.maps = {
    ...
    dynamic: {
      tile_layer: {
        ...
        url: "https://osm.cdsh.dev/hot/{z}/{x}/{y}.png",
        api_key: false,
        foo: "bar=baz",
        attribution: %(
    ...
    # geocoding: { host: "46.248.162.178:8080", use_https: false }
    geocoding: { host: "nominatim.cdsh.dev", use_https: true }
