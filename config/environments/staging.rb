Rails.application.configure do
  ...
  # config.action_controller.asset_host = 'https://bo.testum.warszawa.pl/'
  ...
  # config.active_job.queue_name_prefix = "decidim_bo_#{Rails.env}"
  config.active_job.queue_adapter = :sidekiq
  config.action_mailer.perform_caching = false
  config.action_mailer.asset_host = 'https://bo.testum.warszawa.pl'
