...
(function (exports) {
  ...
  var compact = function compact(items) {
    return items.filter(function (part) {
      return part !== null && typeof part !== "undefined" && ("" + part).trim().length > 0;
    });
  };
  var formatAddress = function formatAddress(object, keys) {
...
(function (exports) {
  ...
  $(function () {
    var generateAddressLabel = exports.Decidim.geocodingFormatAddress;
