...
module Decidim
  module Projects
    ...
    # formats.
    class VoteCardSerializer < Decidim::Exporters::Serializer
      ...
      def headers
        [
          ...
          'Adres e-mail',
          'Sposób głosowania',
          'Status karty do głosowania',
          # 'Błąd: liczba projektów ogólnomiejskich ponad limit',
          # 'Błąd: liczba projektów dzielnicowych ponad limit',
          # 'Błąd: brak nr PESEL',
          # 'Błąd: błędny nr PESEL',
          # 'Błąd: brak podpisu',
          # 'Błąd: tożsamość niepotwierdzona',
          # 'Błąd: karta oddana wielokrotnie na te same dane',
          # 'Błąd: brak wybranych projektów',
          # 'Błąd: karta oddana poza terminem głosowania',
          # 'Błąd: dane nieczytelne',
          # 'Błąd: niepoprawna karta',
          'Dzielnica',
          'Liczba wybranych projektów',
          'Liczba wybranych projektów ogólnomiejskich',
          'Liczba wybranych projektów dzielnicowych',
          'Łączny koszt',
          ...
          'Imię z bazy do weryfikacji',
          'Nazwisko z bazy do weryfikacji'
          # 'Które dane nieprawidłowe'
        ]
      end
      ...
      def serialize
        {
          ...
          created_at: I18n.localize(vote_card.created_at, format: :decidim_short), # 'Data utworzenia',
          ...
          first_name: vote_card.first_name,     # 'Imię',
          last_name: vote_card.last_name,       # 'Nazwisko',
          pesel_number: vote_card.pesel_number, # 'Nr PESEL',
          ...
          city: vote_card.city, #             'Miejscowość',
          street: vote_card.street, # 'Adres zamieszkania - ulica',
          street_number: vote_card.street_number, #           'Adres zamieszkania - nr domu',
          flat_number: vote_card.flat_number, # 'Adres zamieszkania - nr lokalu',
          zip_code: vote_card.zip_code,       # 'Adres zamieszkania - kod pocztowy',
          email: vote_card.email,             # 'Adres e-mail',
          ...
          c8: vote_card.verification_results['voter_first_name'], # 'Imię z bazy do weryfikacji',
          c9: vote_card.verification_results['voter_last_name'] # 'Nazwisko z bazy do weryfikacji',
