...
(function($){
    ...
    function MultiSelect( element, options )
    {
        ...
        if( 'placeholder' in this.options ) {
            this.options.texts.placeholder = this.element.getAttribute('data-placeholder');
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            // mod. CS: add global submit form link
            optionsList.before('<a href="#" class="ms-submitform global">Wybierz</a>');
            ...
            // mod. CS: handle submit form option
            optionsWrap.on('click', '.ms-submitform', function( event ){
                event.preventDefault();
                var form = $(this).closest('form');
                var vote_btn_js = form.find('.vote-wizard-search-js:first');

                if (vote_btn_js.length>0) {
                    vote_btn_js.click();
                } else {
                    form.submit();
                }
        ...
        _updatePlaceholderText: function(){
            ...
            if( selOpts.length ) {
                placeholder.attr('data-label', instance.options.texts.placeholder);
            ...
            // if copy is larger than button width use "# selected"
                ...
                placeholderTxt.text( instance.options.texts.selectedOptions + " " + selectVals.length );
            }
        },
