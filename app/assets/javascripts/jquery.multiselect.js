...
(function($){
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            $(instance.element).after('<div id="ms-list-'+ instance.listNumber +'" class="ms-options-wrap" aria-expanded="true"><button type="button"><span>None Selected</span></button><div class="ms-options"><ul></ul></div></div>');
        ...
        _updatePlaceholderText: function(){
            ...
            // if copy is larger than button width use "# selected"
                ...
                placeholderTxt.html( instance.options.texts.selectedOptions + " " +
                    selectVals.length + "<span class='wcag-invisible'>: " + selOpts.join( ', ' ) + "</span>" );
            }
        },
