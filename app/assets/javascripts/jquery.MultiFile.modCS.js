		...
		this
			...
			.each(function () {
				...
				MultiFile.addSlave = function (slave, slave_count) {
					...
					slave.change(function (a, b, c) {
						...
						if (ERROR.length > 0) {
							...
							// delete visible form error label
							$(this).parent().siblings("small.form-error").removeClass("is-visible"); 
				...
				MultiFile.addToList = function (slave, slave_count, files) {
					...
					MultiFile.STRING.remove = MultiFile.STRING.remove.replace(/\$(file|name)/gi, filesNames.join(', ')); // mod. CS
