...
ActiveRecord::Schema.define(version: 2023_08_31_113602) do
  ...
  create_table "decidim_admin_extended_banned_words", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "decidim_admin_extended_budget_info_groups", force: :cascade do |t|
    t.string "name"
    t.string "subtitle"
    t.boolean "published"
  ...
  create_table "decidim_admin_extended_budget_info_positions", force: :cascade do |t|
    t.string "name"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "budget_info_group_id"
    t.boolean "on_main_site", default: false
    t.index ["budget_info_group_id"], name: "index_positions_on_group_id"
  end

  create_table "decidim_admin_extended_contact_info_groups", force: :cascade do |t|
    t.string "name"
    t.string "subtitle"
    t.boolean "published"
    t.integer "weight", default: 1
  ...
  create_table "decidim_admin_extended_contact_info_positions", force: :cascade do |t|
    t.string "name"
    t.string "position"
    t.string "phone"
    t.string "email"
    t.boolean "published"
    t.integer "weight", default: 1
    t.bigint "contact_info_group_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["contact_info_group_id"], name: "index_contact_positions_on_group_id"
  end

  create_table "decidim_admin_extended_department_delegations", force: :cascade do |t|
  ...
  create_table "decidim_admin_extended_departments", force: :cascade do |t|
    t.string "name"
    t.string "ad_name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "old_id"
    t.string "old_type"
    t.boolean "allow_returning_projects", default: false
    t.boolean "active", default: false
    t.integer "department_type"
  end

  create_table "decidim_admin_extended_documents", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "folder_id"
    t.boolean "coordinators", default: false
    t.boolean "sub_coordinators", default: false
    t.boolean "verifiers", default: false
    t.boolean "editors", default: false
    t.index ["folder_id"], name: "index_decidim_admin_extended_documents_on_folder_id"
  end

  create_table "decidim_admin_extended_faq_groups", force: :cascade do |t|
    t.string "title"
    t.string "subtitle"
  ...
  create_table "decidim_admin_extended_faqs", force: :cascade do |t|
    t.string "title"
    t.string "content"
    t.integer "weight", default: 1
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "faq_group_id"
    t.boolean "published"
    t.index ["faq_group_id"], name: "index_decidim_admin_extended_faqs_on_faq_group_id"
  end

  create_table "decidim_admin_extended_folders", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "decidim_admin_extended_mail_templates", force: :cascade do |t|
    t.string "name"
  ...
  create_table "decidim_admin_extended_newsletter_recipients_from_files", force: :cascade do |t|
    t.string "email"
    t.string "name"
    t.datetime "sent_at"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["newsletter_id"], name: "decidim_admin_newsletter_recipients_newsletter_id"
    t.index ["organization_id"], name: "decidim_admin_newsletter_organization_newsletter_id"
  end

  create_table "decidim_admin_extended_recipients", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "decidim_attachments", id: :serial, force: :cascade do |t|
    ...
    t.string "eval_file_type"
    t.boolean "temporary_file", default: false
  ...
  create_table "decidim_coauthorships", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "decidim_author_type", null: false
    t.datetime "coauthorship_acceptance_date"
    t.string "confirmation_status", default: "waiting"
    t.boolean "coauthor", default: false
  ...
  create_table "decidim_core_extended_notes", force: :cascade do |t|
    t.bigint "user_id"
    t.string "title"
    t.string "body"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_decidim_core_extended_notes_on_user_id"
  end
  ...
  create_table "decidim_organizations", id: :serial, force: :cascade do |t|
    ...
    t.jsonb "newsletter_smtp_settings"
  ...
  create_table "decidim_participatory_processes", id: :serial, force: :cascade do |t|
    ...
    t.date "project_editing_end_date"
    t.date "withdrawn_end_date"
    t.datetime "evaluation_end_date"
    t.datetime "evaluation_publish_date"
    t.datetime "appeal_start_date"
    t.datetime "appeal_end_date"
    t.datetime "reevaluation_publish_date"
    t.date "paper_project_submit_end_date"
    t.datetime "evaluation_cards_submit_end_date"
    t.date "paper_voting_submit_end_date"
    t.date "status_change_notifications_sending_end_date"
    t.integer "old_id"
    t.integer "global_scope_projects_voting_limit", default: 10
    t.integer "district_scope_projects_voting_limit", default: 15
    ...
    t.date "reevaluation_cards_submit_end_date"
    t.date "reevaluation_end_date"
    t.datetime "show_start_voting_button_at"
    t.datetime "show_voting_results_button_at"
  ...
  create_table "decidim_processes_extended_scope_budgets", force: :cascade do |t|
    t.bigint "decidim_scope_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_participatory_process_id"], name: "index_scope_budgets_on_process_id"
    t.index ["decidim_scope_id"], name: "index_scope_budgets_on_scope_id"
  end

  create_table "decidim_projects_admin_conversations", force: :cascade do |t|
    t.integer "project_id"
    t.integer "sender_id"
    t.integer "receiver_id"
    t.text "message_content"
    t.integer "message_source"
    t.integer "message_author"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "message_uuid"
    t.index ["project_id"], name: "decidim_projects_admin_conversations_project_id"
    t.index ["receiver_id"], name: "decidim_projects_admin_conversations_user_receiver_id"
    t.index ["sender_id"], name: "decidim_projects_admin_conversations_sender_id"
  end

  create_table "decidim_projects_appeals", force: :cascade do |t|
    t.bigint "project_id"
    t.bigint "author_id"
    t.text "body"
    t.datetime "time_of_submit"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "is_paper", default: false
    t.string "entering_person_name"
    t.index ["author_id"], name: "index_decidim_projects_appeals_on_author_id"
    t.index ["project_id"], name: "index_decidim_projects_appeals_on_project_id"
  end

  create_table "decidim_projects_drawing_projects_logs", force: :cascade do |t|
    t.bigint "all_project_ids", default: [], array: true
    t.bigint "winning_project_ids", default: [], array: true
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "scope_id"
    t.index ["scope_id"], name: "index_decidim_projects_drawing_projects_logs_on_scope_id"
  end

  create_table "decidim_projects_evaluations", force: :cascade do |t|
    t.integer "project_id"
    t.integer "user_id"
    t.string "type"
    t.jsonb "details"
  ...
  create_table "decidim_projects_implementation_photos", force: :cascade do |t|
    t.bigint "project_id"
    t.string "image_alt"
    t.integer "weight", default: 0
    t.boolean "main_attachment", default: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_decidim_projects_implementation_photos_on_project_id"
  end

  create_table "decidim_projects_implementations", force: :cascade do |t|
    t.text "body"
    t.bigint "user_id"
    t.bigint "project_id"
    ...
    t.datetime "updated_at", null: false
    t.jsonb "update_data"
    t.index ["project_id"], name: "index_decidim_projects_implementations_on_project_id"
    t.index ["user_id"], name: "index_decidim_projects_implementations_on_user_id"
  end

  create_table "decidim_projects_import_logs", force: :cascade do |t|
    t.integer "old_id"
    t.string "resource_type"
    t.string "message"
    t.jsonb "body"
  ...
  create_table "decidim_projects_poster_templates", force: :cascade do |t|
    t.string "title"
    t.string "subtitle"
    t.boolean "published", default: false
    t.bigint "decidim_participatory_process_id"
    ...
    t.datetime "updated_at", null: false
    t.text "sample_title"
    t.text "sample_project_number"
    t.text "sample_project_area"
    t.integer "project_title_height", default: 0
    t.integer "project_number_height", default: 0
    t.integer "project_area_height", default: 0
    t.index ["decidim_participatory_process_id"], name: "poster_templates_on_decidim_participatory_process_id"
  end

  create_table "decidim_projects_project_areas", force: :cascade do |t|
    t.bigint "decidim_projects_project_id"
    t.bigint "decidim_area_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_area_id"], name: "index_on_projects_on_areas_id"
    t.index ["decidim_projects_project_id"], name: "index_on_areas_on_projects_id"
  end

  create_table "decidim_projects_project_conflicts", force: :cascade do |t|
    t.bigint "project_id"
    t.bigint "second_project_id"
    t.index ["project_id"], name: "index_decidim_projects_project_conflicts_on_project_id"
    t.index ["second_project_id"], name: "index_decidim_projects_project_conflicts_on_second_project_id"
  end

  create_table "decidim_projects_project_customizations", force: :cascade do |t|
    t.bigint "decidim_participatory_process_id"
    t.jsonb "additional_attributes"
    t.jsonb "custom_names"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_participatory_process_id"], name: "decidim_project_custom_on_participatory_process_id"
  end

  create_table "decidim_projects_project_department_assignments", force: :cascade do |t|
    t.bigint "department_id"
    t.bigint "project_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["department_id"], name: "index_assignements_on_department_id"
    t.index ["project_id"], name: "index_assignements_on_project_id"
  end

  create_table "decidim_projects_project_ranks", force: :cascade do |t|
    t.bigint "project_id"
    t.bigint "scope_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "votes_limit_reached", default: false
    t.string "status"
    t.bigint "drawing_projects_log_id"
    t.integer "votes_count", default: 0
    t.decimal "percentage_of_scope_votes", precision: 5, scale: 2
    t.index ["project_id"], name: "index_decidim_projects_project_ranks_on_project_id"
    t.index ["scope_id"], name: "index_decidim_projects_project_ranks_on_scope_id"
  end

  create_table "decidim_projects_project_recipients", force: :cascade do |t|
    t.bigint "decidim_projects_project_id"
    t.bigint "decidim_admin_extended_recipient_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_admin_extended_recipient_id"], name: "index_on_projects_on_recipients_id"
    t.index ["decidim_projects_project_id"], name: "index_on_recipients_on_projects_id"
  end

  create_table "decidim_projects_project_user_assignments", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "project_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id"], name: "index_projects_on_department_id"
    t.index ["user_id"], name: "index_departments_on_project_id"
  end

  create_table "decidim_projects_project_votes", force: :cascade do |t|
    t.bigint "decidim_projects_project_id"
    t.bigint "decidim_projects_vote_card_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_projects_project_id"], name: "index_on_votes_on_project_id"
    t.index ["decidim_projects_vote_card_id"], name: "index_on_projects_on_vote_id"
  end

  create_table "decidim_projects_projects", force: :cascade do |t|
    t.string "title"
    t.text "body"
    t.string "state"
    t.string "reference"
    ...
    t.decimal "budget_value", precision: 14, scale: 2, default: "0.0"
    ...
    t.boolean "future_maintenance"
    t.text "future_maintenance_description"
    t.decimal "future_maintenance_value", precision: 14, scale: 2
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.text "custom_recipients"
    t.text "custom_categories"
    t.integer "current_department_id"
    t.boolean "unreadable"
    t.boolean "formal_result"
    t.boolean "meritorical_result"
    t.boolean "reevaluation_result"
    t.boolean "implementation_on_main_site", default: false
    t.jsonb "locations", default: {}, null: false
    t.boolean "no_scope_selected"
    t.boolean "signed_by_author"
    t.integer "implementation_status"
    t.boolean "chosen_for_voting", default: false
    t.boolean "chosen_for_implementation", default: false
    t.integer "votes_count"
    t.decimal "votes_percentage", precision: 10, scale: 2
    t.integer "old_id"
    t.text "evaluation_note"
    t.boolean "signed_by_coauthor1"
    t.boolean "signed_by_coauthor2"
    t.string "contractors_and_costs"
    t.jsonb "additional_data", default: {}
    t.string "recipient_names"
    t.string "category_names"
    t.boolean "implementation_on_main_site_slider", default: false
    t.jsonb "admin_changes"
    t.integer "factual_budget_value"
    t.string "public_attachment_names"
    t.string "all_attachment_names"
    t.integer "region_id"
    t.text "return_reason"
    t.integer "current_sub_coordinator_id"
    t.jsonb "coauthors_data", default: {}
    t.integer "follows_count", default: 0
    t.integer "conflict_status", default: 0
    t.jsonb "main_location"
    t.string "signum_spr_id"
    t.string "signum_nr_kancelaryjny"
    t.string "signum_kor_id"
    t.string "signum_znak_sprawy"
    t.datetime "signum_registered_at"
    t.integer "signum_registered_by_user_id"
    t.boolean "offensive", default: false
    t.bigint "notification_about_evaluation_results_send_by_id"
    t.datetime "notification_about_evaluation_results_send_at"
    t.datetime "mail_delivered_at"
    t.index ["decidim_component_id"], name: "index_decidim_projects_projects_on_decidim_component_id"
    t.index ["decidim_scope_id"], name: "index_decidim_projects_projects_on_decidim_scope_id"
    t.index ["evaluator_id"], name: "index_decidim_projects_projects_on_evaluator_id"
    t.index ["notification_about_evaluation_results_send_by_id"], name: "index_projects_notif_eval_res_send_by_id"
  end

  create_table "decidim_projects_regions", force: :cascade do |t|
    t.string "name"
    t.integer "old_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "decidim_projects_simple_users", force: :cascade do |t|
    ...
    t.boolean "show_my_name", default: false
    t.boolean "inform_me_about_proposal", default: false
    t.boolean "email_on_notification", default: false
    t.integer "old_id"
    t.boolean "inform_about_admin_changes", default: false
    t.boolean "watched_implementations_updates", default: false
    t.boolean "newsletter", default: false
    t.boolean "inform_me_about_comments", default: false
    t.boolean "allow_private_message", default: false
    t.index ["organization_id"], name: "decidim_organization_unregistered_author_id"
  end

  create_table "decidim_projects_statistics_participatory_processes", force: :cascade do |t|
    t.integer "scope_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["participatory_process_id"], name: "statistics_participatory_processes_process_id"
    t.index ["scope_id", "participatory_process_id"], name: "statistics_participatory_processes_uniq_scope", unique: true
    t.index ["scope_id"], name: "statistics_participatory_processes_scope_id"
  end

  create_table "decidim_projects_vote_cards", force: :cascade do |t|
    t.bigint "decidim_component_id"
    t.bigint "scope_id"
    t.string "email"
    t.string "status"
    ...
    t.string "ip_number"
    t.boolean "cleared_data", default: false
    t.datetime "resend_email_date"
    t.integer "resend_email_user_id"
    t.integer "resend_email_counter", default: 0
    t.json "projects_in_districts_scope"
    t.json "projects_in_global_scope"
    t.integer "district_projects_count", default: 0
    t.integer "global_projects_count", default: 0
    t.datetime "submitted_at"
    t.json "verification_results", default: {}
    t.datetime "activated_at"
    t.index ["decidim_component_id"], name: "decidim_component_projects_vote_id"
    t.index ["resend_email_user_id"], name: "index_decidim_projects_vote_cards_on_resend_email_user_id"
    t.index ["scope_id"], name: "decidim_scope_projects_vote_id"
  end

  create_table "decidim_projects_vote_statistics", force: :cascade do |t|
    t.bigint "vote_card_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "voting_timetable", default: {}
    t.index ["vote_card_id"], name: "index_decidim_projects_vote_statistics_on_vote_card_id"
  end

  create_table "decidim_projects_voters", force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
    t.string "pesel"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["pesel"], name: "index_decidim_projects_voters_on_pesel"
  end
  ...
  create_table "decidim_proposals_extended_evaluations", force: :cascade do |t|
  ...
  create_table "decidim_proposals_extended_proposal_areas", force: :cascade do |t|
    t.bigint "decidim_proposals_proposal_id"
    t.bigint "decidim_area_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_area_id"], name: "index_on_proposals_on_areas_id"
    t.index ["decidim_proposals_proposal_id"], name: "index_on_areas_on_proposals_id"
  end

  create_table "decidim_proposals_extended_proposal_recipients", force: :cascade do |t|
    t.bigint "decidim_proposals_proposal_id"
    t.bigint "decidim_admin_extended_recipient_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["decidim_admin_extended_recipient_id"], name: "index_on_proposals_on_recipients_id"
    t.index ["decidim_proposals_proposal_id"], name: "index_on_recipients_on_proposals_id"
  end
  ...
  create_table "decidim_proposals_proposals", id: :serial, force: :cascade do |t|
    ...
    t.index ["evaluator_id"], name: "index_decidim_proposals_proposals_on_evaluator_id"
  ...
  create_table "decidim_static_page_topics", force: :cascade do |t|
    ...
    t.boolean "scroll_template", default: false
    t.string "template"
  ...
  create_table "decidim_users", id: :serial, force: :cascade do |t|
    ...
    t.string "admin_comment_name"
    t.string "all_old_ids"
    t.boolean "allow_private_message"
    t.boolean "newsletter"
    t.boolean "implementations_updates"
    t.boolean "watched_implementations_updates"
    t.boolean "inform_about_admin_changes"
    t.boolean "inform_me_about_comments"
    t.boolean "ad_access_active", default: false
    t.date "ad_access_deactivate_date"
  ...
  create_table "project_versions", force: :cascade do |t|
    ...
    t.datetime "created_at"
    t.string "signature"
    t.index ["item_type", "item_id"], name: "index_project_versions_on_item_type_and_item_id"
  end
  ...
  add_foreign_key "decidim_core_extended_notes", "decidim_users", column: "user_id"
  ...
  add_foreign_key "decidim_processes_extended_scope_budgets", "decidim_participatory_processes"
  add_foreign_key "decidim_processes_extended_scope_budgets", "decidim_scopes"
  add_foreign_key "decidim_projects_admin_conversations", "decidim_projects_projects", column: "project_id"
  add_foreign_key "decidim_projects_admin_conversations", "decidim_users", column: "receiver_id"
  add_foreign_key "decidim_projects_admin_conversations", "decidim_users", column: "sender_id"
  add_foreign_key "decidim_projects_appeals", "decidim_projects_projects", column: "project_id"
  add_foreign_key "decidim_projects_appeals", "decidim_users", column: "author_id"
  add_foreign_key "decidim_projects_implementations", "decidim_projects_projects", column: "project_id"
  add_foreign_key "decidim_projects_implementations", "decidim_users", column: "user_id"
  add_foreign_key "decidim_projects_project_conflicts", "decidim_projects_projects", column: "project_id"
  add_foreign_key "decidim_projects_project_conflicts", "decidim_projects_projects", column: "second_project_id"
  add_foreign_key "decidim_projects_project_department_assignments", "decidim_admin_extended_departments", column: "department_id"
  add_foreign_key "decidim_projects_project_department_assignments", "decidim_projects_projects", column: "project_id"
  add_foreign_key "decidim_projects_project_ranks", "decidim_projects_projects", column: "project_id"
  add_foreign_key "decidim_projects_project_ranks", "decidim_scopes", column: "scope_id"
  add_foreign_key "decidim_projects_project_user_assignments", "decidim_projects_projects", column: "project_id"
  add_foreign_key "decidim_projects_project_user_assignments", "decidim_users", column: "user_id"
  add_foreign_key "decidim_projects_projects", "decidim_components"
  add_foreign_key "decidim_projects_projects", "decidim_users", column: "evaluator_id"
  add_foreign_key "decidim_projects_projects", "decidim_users", column: "notification_about_evaluation_results_send_by_id"
  add_foreign_key "decidim_projects_vote_statistics", "decidim_projects_vote_cards", column: "vote_card_id"
  add_foreign_key "decidim_proposals_proposals", "decidim_users", column: "evaluator_id"
